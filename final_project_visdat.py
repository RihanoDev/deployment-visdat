# -*- coding: utf-8 -*-
"""Final_Project_Visdat.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-CzkXY_jtGKjV84rfdpOsT3M20X7FjPf
...
st.title('Visualisasi Data Interactive')
st.bokeh_chart(output_file)

#import data
output_file('final_project.html',
            title='Visdat_final Project')
...
# set circle info
circle_data = {'source': source, 'size': 3,
               'alpha': 0.7, 'selection_color': 'black'}
...
hover_glyph = figure1.circle(x='date', y='close', source=source,
                             size=3, alpha=0, hover_fill_color='black', hover_alpha=0.5)
...
hover_glyph = figure2.circle(x='date', y='volume', source=source,
                             size=3, alpha=0, hover_fill_color='black', hover_alpha=0.5)
figure2.add_tools(HoverTool(tooltips=tooltips, renderers=[hover_glyph]))

"""# **Figure Change Per DAY**"""
...
hover_glyph = figure3.circle(x='date', y='change', source=source,
                             size=3, alpha=0, hover_fill_color='black', hover_alpha=0.5)
figure3.add_tools(HoverTool(tooltips=tooltips, renderers=[hover_glyph]))

"""# **Figure Value Data Saham**"""
...
hover_glyph = figure4.circle(x='date', y='value', source=source,
                             size=3, alpha=0, hover_fill_color='black', hover_alpha=0.5)
figure3.add_tools(HoverTool(tooltips=tooltips, renderers=[hover_glyph]))

"""# **Fitur Hide pada Legend**"""
